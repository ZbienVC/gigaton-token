...
export default function HowToBuy() {
  const steps = [
    ...
    { num: "02", title: "Go to DeDust or Groypfi", text: "Navigate to dedust.io or groypfi.io and connect your TON wallet.", icon: <Search className="w-7 h-7" style={{ color: '#00B4FF' }} />, glow: 'rgba(0,180,255,0.07)', border: 'rgba(0,180,255,0.2)' },
